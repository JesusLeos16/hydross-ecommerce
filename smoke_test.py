...
def main():
    with sync_playwright() as playwright:
        ...
        assert "Tu piel" in page.locator("h1").first.inner_text()
        ...
        assert page.get_by_text("Agregado a tu ritual").is_visible()
        ...
        page.get_by_role("button", name="Ir al checkout").click()
        ...
        page.goto("http://127.0.0.1:5173/ritual", wait_until="networkidle")
        for index in range(3):
            page.locator(".ritual-options button").nth(0).click()
        assert page.get_by_text("Tu ritual hydross").is_visible()
        browser.close()
