  ...
  return (
    <article className="product-card">
      ...
      <div className="product-card-copy">
        ...
        <div className="product-buy"><span>{formatPrice(product.priceMXN)}</span><button onClick={() => addItem(product)} aria-label={`Agregar ${product.name} al carrito`}><Plus size={17} /></button></div>
      </div>
    </article>
  )
}
